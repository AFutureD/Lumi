...
@Test func newPayloadsRoundTripThroughCoding() throws {
    ...
    let old = Data("""
    {"summary":{"id":"s","agent":"codex","title":"t","lifecycle":"running","phase":"idle","startedAt":"2024-01-01T00:00:00Z","updatedAt":"2024-01-01T00:00:00Z","lastActivityAt":"2024-01-01T00:00:00Z","needsAttention":false,"needsReview":false,"hiddenInNotch":false,"hiddenByFilter":false,"filterEvaluated":true},"timeline":[]}
    """.utf8)
