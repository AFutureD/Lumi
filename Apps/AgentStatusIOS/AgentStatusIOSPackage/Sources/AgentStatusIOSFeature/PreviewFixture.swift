...
enum PreviewFixture {
    ...
    private static func macBookProSessions(now: Date) -> [SessionDetail] {
        ...
        add(32, .tool(.init(name: "apply_patch", summary: "AgentStatusCore/SessionStatusTone.swift", status: .started, toolUseID: "t2")))
        add(33, .tool(.init(name: "apply_patch", summary: "AgentStatusCore/SessionStatusTone.swift", status: .succeeded, durationMilliseconds: 210, toolUseID: "t2")))
        ...
        add(95, .tool(.init(
            name: "shell",
            summary: "error: no such module 'AppKit'\n --> Common/Sources/AgentStatusTransport/SessionEnvelope.swift:4:8\n  |\n4 | import AppKit\n  |        ^\nCompiling AgentStatusTransport (12 sources)\nerror: fatalError",
        ...
        add(173, .plan(.init(explanation: "Plan updated", steps: [
            ...
            .init(text: "Move DTOs into AgentStatusTransport", status: .completed),
