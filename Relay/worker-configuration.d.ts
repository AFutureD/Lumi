/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9fc48b748814d0464775857f8b329dda)
// Runtime types generated with workerd@1.20260811.1 2026-08-16 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMITER: RateLimit;
	LOG_LEVEL: "info";
	APNS_TOPIC: "app.huanan.lumi";
	APNS_KEY_ID: string;
	APNS_TEAM_ID: string;
	APNS_PRIVATE_KEY: string;
	HOST_RELAY: DurableObjectNamespace<import("./src/index").HostRelay>;
	PAIRING_DIRECTORY: DurableObjectNamespace<import("./src/index").PairingDirectory>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HostRelay" | "PairingDirectory";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_LEVEL" | "APNS_TOPIC" | "APNS_KEY_ID" | "APNS_TEAM_ID" | "APNS_PRIVATE_KEY">> {}
}
